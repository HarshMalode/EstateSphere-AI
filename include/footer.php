<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        ...
                                        <p class="pb-20 text-white">Transforming spaces into valuable assets through property development, investment, and management. Real estate connects individuals and businesses with opportunities to build secure and sustainable futures.</p>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Real Estate Website - Developed By Harshwardhan Gokul Malode</span> </div>
                    <div class="col-sm-6">
